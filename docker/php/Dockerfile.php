...
# Install extensions and redis
RUN apt-get update && apt-get install -y libpq-dev && docker-php-ext-install pdo_pgsql gd zip

ADD ./docker/php/crontab /etc/cron.d/cron
